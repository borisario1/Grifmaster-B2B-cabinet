 ...
 */
it('Проверка импорта товаров из внешнего CSV файла', function () {
 ...
 */
it('Проверка обновления товара и даты синхронизации', function () {
 ...
 */
it('Если пришло 0 строк - БД не очищается, параметры товаров не изменены', function () {
    $initialData = [
        'article' => 'EXISTING-01',
        'name' => 'Важный товар',
        'free_stock' => 10
